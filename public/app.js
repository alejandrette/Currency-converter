...
let apiKey = `https://v6.exchangerate-api.com/v6/${API_KEY}/latest/USD`;
...
// Función que se encarga de realizar el cambio de moneda 
const currencyConverter = () => {
    ...
    fetch(apiKey)
        ...
        .then(data => {
            ...
            message.innerHTML = `<span style="color: gray;">${amount.value.replace(".",",")} ${firstNamePlural} = </span> <br> 
